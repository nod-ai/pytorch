...
namespace at::detail {
    ...
    TORCH_HIP_API TensorBase empty_zoom(IntArrayRef size, const TensorOptions &options);
    ...
    TORCH_HIP_API TensorBase empty_strided_zoom(IntArrayRef size, IntArrayRef stride, const TensorOptions &options);
