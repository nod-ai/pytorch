...
/*
  Provides the implementations of hipSPARSE function templates.
*/
...
void csrgeam2_bufferSizeExt<float>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseScsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2_bufferSizeExt<double>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseDcsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2_bufferSizeExt<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCcsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
...
void csrgeam2_bufferSizeExt<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZcsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
...
void csrgeam2<float>(HIPSPARSE_CSRGEAM2_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseScsrgeam2(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2<double>(HIPSPARSE_CSRGEAM2_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDcsrgeam2(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCcsrgeam2(
      handle,
      m,
      n,
      reinterpret_cast<const hipComplex*>(alpha),
...
void csrgeam2<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZcsrgeam2(
      handle,
      m,
      n,
      reinterpret_cast<const hipDoubleComplex*>(alpha),
...
void bsrmm<float>(HIPSPARSE_BSRMM_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmm<double>(HIPSPARSE_BSRMM_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmm<c10::complex<float>>(HIPSPARSE_BSRMM_ARGTYPES(c10::complex<float>)) {
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmm<c10::complex<double>>(
    HIPSPARSE_BSRMM_ARGTYPES(c10::complex<double>)) {
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmv<float>(HIPSPARSE_BSRMV_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrmv<double>(HIPSPARSE_BSRMV_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrmv<c10::complex<float>>(HIPSPARSE_BSRMV_ARGTYPES(c10::complex<float>)) {
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrmv<c10::complex<double>>(
    HIPSPARSE_BSRMV_ARGTYPES(c10::complex<double>)) {
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<float>(HIPSPARSE_BSRSV2_BUFFER_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<double>(HIPSPARSE_BSRSV2_BUFFER_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<float>(HIPSPARSE_BSRSV2_ANALYSIS_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<double>(HIPSPARSE_BSRSV2_ANALYSIS_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<float>(HIPSPARSE_BSRSV2_SOLVE_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<double>(HIPSPARSE_BSRSV2_SOLVE_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsm2_bufferSize<float>(HIPSPARSE_BSRSM2_BUFFER_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_bufferSize<double>(HIPSPARSE_BSRSM2_BUFFER_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_bufferSize<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_bufferSize<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<float>(HIPSPARSE_BSRSM2_ANALYSIS_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<double>(HIPSPARSE_BSRSM2_ANALYSIS_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<float>(HIPSPARSE_BSRSM2_SOLVE_ARGTYPES(float)) {
  TORCH_HIPSPARSE_CHECK(hipsparseSbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<double>(HIPSPARSE_BSRSM2_SOLVE_ARGTYPES(double)) {
  TORCH_HIPSPARSE_CHECK(hipsparseDbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<c10::complex<float>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseCbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<c10::complex<double>>(
  ...
  TORCH_HIPSPARSE_CHECK(hipsparseZbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
