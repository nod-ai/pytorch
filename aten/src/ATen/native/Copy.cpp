...
bool is_supported_device(Device device) {
  ...
  return device_type == kPrivateUse1 || device_type == kCPU || device_type == kCUDA || device_type == kHIP || device_type == kVulkan || device_type == kMetal || device_type == kMPS || device_type == kXPU;
}
