...
SparseTensor _coalesce_sparse_zoom(const SparseTensor& self) {
  ...
  if (newValues.numel() > 0) {
    ...
    AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND4(
      ...
      values.scalar_type(), "coalesce_sparse_zoom", [&] {
        using zoom_accscalar_t = acc_type<scalar_t, /* is_zoom */ true>;
       hipLaunchKernelGGL(( apply::coalesceValuesKernel<scalar_t, zoom_accscalar_t>), dim3(grid), dim3(block), 0, stream, 
